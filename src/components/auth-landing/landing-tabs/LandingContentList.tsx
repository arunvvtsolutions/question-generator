...
const LandingContentList: FC<ITestProps> = ({ chapters, baseLink, shortUrl, showAll = false }) => {
    ...
    <div className="relative">
      <div
        className={`scrollbar-thin transition-all relative ${
          open || showAll ? "lg:h-max pr-2" : "lg:max-h-[200px] max-h-[265px] overflow-hidden"
        }`}
      >
...
export default LandingContentList;

  ...
  return (
    ...
    >
      <switch>
        ...
        <g>
          <g>
            <path d="M50,52.8c1.6,0,3-1.3,3-3V36.3c0-1.6-1.3-3-3-3c-1.6,0-3,1.3-3,3v13.5C47,51.5,48.4,52.8,50,52.8z" />
            <circle cx="50" cy="58.7" r="3.2" />
            <path d="M51.2,19.2c-7.2-0.3-14.1,2.2-19.3,7.2c-5.2,5-8.1,11.7-8.1,18.9c0,5.9,1.9,11.5,5.6,16.2c3.2,4.1,5.4,8,6.8,12.1     l0.1,0.3v10.5c0,1.3,1,2.5,2.3,2.7C39.1,92.9,44,97.5,50,97.5c6,0,10.9-4.6,11.4-10.5c1.3-0.2,2.3-1.3,2.3-2.7V73.9l0.1-0.3     c1.4-4.1,3.6-8,6.8-12c3.9-4.9,5.9-11.1,5.6-17.3C75.5,30.8,64.6,19.8,51.2,19.2z M50,92c-3,0-5.4-2.2-5.9-5h11.8     C55.4,89.9,53,92,50,92z M58.2,81.6H41.8V75h16.4V81.6z M66.2,58.1c-3,3.8-5.2,7.5-6.8,11.4H40.6c-1.6-3.8-3.8-7.6-6.8-11.4     c-2.9-3.7-4.4-8.1-4.4-12.8c0-5.7,2.3-11,6.4-15c4.1-3.9,9.5-6,15.3-5.7c10.6,0.5,19.2,9.2,19.7,19.7     C70.9,49.4,69.3,54.2,66.2,58.1z" />

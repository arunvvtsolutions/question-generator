...
export const generateQuestions = async (data: IGenerateQuestBodyProps) => {
  try {
    const res = await axiosService.post(
      `/${Api_endpoint.generate_questions}`,
      data
    );
    return res.data;
  } catch (error: any) {
...
export const generateImproveAiQuestion = async (
  questionId: number,
  feedback: string
) => {
  try {
...
export const getAllQuestions = async (): Promise<{
  ...
  try {
    const res = await axiosService.get(
      `${BASE_URL}/${Api_endpoint.get_all_ai_questions}`
    );
    return res.data;
  } catch (error: any) {
...
export const getSingleAiQuestion = async (
  userId: number,
  uuid: string
): Promise<{
  success: boolean;
  ...
  try {
    const res = await axiosService.get(
      `${BASE_URL}/${Api_endpoint.get_single_ai_questions}?userId=${userId}&uuId=${uuid}`
    );
    return res.data;
  } catch (error: any) {
    return { success: false };
...
export const viewGeneratedQuestionsWithId = async (
  ...
  try {
    const res = await axiosService.get(
      `/${Api_endpoint.view_questions}/${uuId ? uuId : ""}`
    );
    return res.data;
  } catch (error: any) {
    return (
...
export const viewGeneratedQuestions = async (): Promise<{
  success: boolean;
  data: IViewGeneratedQsts[];
}> => {
  try {
...
export const getCognitiveLevel = async (): Promise<{
  ...
  try {
    const res = await axios.get(
      `${BASE_URL}/${Api_endpoint.get_cognitive_level}`
    );
    return res.data;
  } catch (error: any) {
    return (
...
export const getTokenDetails = async (
  ...
  try {
    const res = await axiosService.get(
      `${BASE_URL}/${Api_endpoint.get_token_details}?userId=${userId}`
    );
    return res.data;
  } catch (error: any) {
    return (
